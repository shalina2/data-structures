...
const countNumberOfElements = (arr) => {
    let sum = 0;
    let s = arr.reduce(function(acc, cur, inx, array){
         return array.length;
    },0);
     return sum;
};
...
const returnNames = (arr) => {
    let newArr = arr.reduce(function(acc, cur, ind,array){
...
const reversedString = (arr) => {
    arr = arr.split('');
    let newArr = arr.reduce(function(acc, cur,inx, array){
...
const countPrimeNumbers = (arr) => {
    let newArr = arr.filter(function(el){
      ...
      newArr.reduce(function(acc, cur){
